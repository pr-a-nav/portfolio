...
const About = () => {
  return (
    <div id="about" className="p-10 pt-52 lg:justify-center flex">
      <div className="lg:max-w-4xl">
        <div className="text-white">
          <span className="primary-color lg:text-lg">01.</span> &nbsp;
        ...
        <div className="flex">
          <div className="mt-10 dull-white">
            <p>
              ...
              that live on the internet or in programming world. My interest is
              in
              <span className="primary-color"> development</span> ,
              <span className="primary-color"> machine learning</span>,
              sometimes I explore the
              <span className="primary-color"> pentesting</span> world and the
              <span className="primary-color"> quantum</span> world which
              belongs to
